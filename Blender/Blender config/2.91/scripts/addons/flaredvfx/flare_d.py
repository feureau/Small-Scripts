...
def flare_d_prop(obs, context, lensflareprop, suffix):
...
##### IRIS 01#####    
    ...
    v2.targets[0].data_path = "lensflareprop.iris_emission"    
    #estressione matematica da fare con le variabili create
    d.expression = "(global_emission+0.35)*iris_emission"
...
##### IRIS 02 #####
    ...
    v2.targets[0].data_path = "lensflareprop.iris_emission"    
    #estressione matematica da fare con le variabili create
    d.expression = "(global_emission+4)*iris_emission"
...
##### IRIS 03 #####            
    ...
    v2.targets[0].data_path = "lensflareprop.iris_emission"    
    #estressione matematica da fare con le variabili create
    d.expression = "(global_emission+10)*iris_emission"
...
##### IRIS 04 #####            
    ...
    v2.targets[0].data_path = "lensflareprop.iris_emission"    
    #estressione matematica da fare con le variabili create
    d.expression = "(global_emission+3)*iris_emission"
...
##### IRIS 06 #####  
    ...
    v2.targets[0].data_path = "lensflareprop.iris_emission"    
    #estressione matematica da fare con le variabili create
    d.expression = "(global_emission+0.15)*iris_emission"
...
##### IRIS 08 ##### 
    ...
    v2.targets[0].data_path = "lensflareprop.iris_emission"    
    #estressione matematica da fare con le variabili create
    d.expression = "(global_emission+2)*iris_emission"
...
##### RGB FLASH #####
    ...
    v2.targets[0].data_path = "lensflareprop.sun_beam_emission"    
    #estressione matematica da fare con le variabili create
    d.expression = "(global_emission+0.5)*sun_beam_emission"
...
##### REFLECT GLOW #####
    ...
    v2.targets[0].data_path = "lensflareprop.glow_emission"    
    #estressione matematica da fare con le variabili create
    d.expression = "(global_emission+5)*glow_emission"
...
##### REFLECT STREAk #####        
    ...
    #estressione matematica da fare con le variabili create
    d.expression = "global_emission+8"
