...
def flare_a_prop(obs, context, lensflareprop, suffix):
...
##### HOOP #####    
    ...
    v2.targets[0].data_path = "lensflareprop.sun_beam_emission"    
    #estressione matematica da fare con le variabili create
    d.expression = "global_emission+(sun_beam_emission/2.5)"
    ...
    v1.targets[0].data_path = "lensflareprop.global_emission"    
    #estressione matematica da fare con le variabili create
    d.expression = "global_emission*5+0.4"
...
##### IRIS 01#####    
    ...
    #estressione matematica da fare con le variabili create
    d.expression = "(global_emission+0.2)*iris_emission"
...
##### IRIS 04 #####            
    slots = obs["Iris04"+suffix].material_slots
    
    for mat in slots:
        irnt = mat.material.node_tree
...
##### IRIS 06 #####  
    slots = obs["Iris06"+suffix].material_slots
    for mat in slots:
        irnt = mat.material.node_tree
...
##### IRIS 08 ##### 
    slots = obs["Iris08"+suffix].material_slots
    for mat in slots:
        irnt = mat.material.node_tree
...
##### IRIS 09 #####
    slots = obs["Iris09"+suffix].material_slots
...
##### RGB FLASH #####
    ...
    v2.targets[0].data_path = "lensflareprop.iris_emission"    
    #estressione matematica da fare con le variabili create
    d.expression = "(global_emission+1.2)*iris_emission"
...
##### REFLECT GLOW #####
    ...
    v2.targets[0].data_path = "lensflareprop.glow_emission"    
    #estressione matematica da fare con le variabili create
    d.expression = "global_emission+(glow_emission*20)"
