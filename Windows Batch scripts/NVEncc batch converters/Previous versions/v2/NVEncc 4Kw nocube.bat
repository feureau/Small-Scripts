...
mkvmerge.exe -o %%A_temp_HDR_4K_vert_crop-%c.mkv --split chapters:all %%A_temp_HDR_4K_vert_crop.mkv

    del %%A_temp_HDR_4K.mkv
    del %%A_temp_HDR_4K_vert_crop.mkv
    del %%A_temp_HDR_8K_Vert_crop.mkv 
    del %%A_HDR_4K_Vert_crop_CUBE.mkv 
    del %%A_HDR_4K_Horz_CUBE.mkv 

    mkdir Processed
    move %%A_HDR_4K_Vert_crop-*.mkv Processed\
    move %%A_HDR_8K_Horz.mkv Processed\
)
