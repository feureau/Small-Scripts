...
start /b /belownormal /wait NVEncC64 --avhw --codec av1 --tier high --profile main --cqp 12 --preset p1 --output-depth 10 --transfer auto --audio-copy --chapter-copy --key-on-chapter --sub-copy --metadata copy --vpp-resize algo=auto --output-res 4320x4320,preserve_aspect_ratio=increase -i %%A -o %%A_HDR_8K_Horz.mkv 
