...
NVEncC64 --avhw --codec av1 --profile high --qvbr 0 --output-depth 10 --multipass 2pass-full --lookahead 32 --nonrefp --aq --aq-temporal --transfer auto --audio-copy --chapter-copy --key-on-chapter --sub-copy --metadata copy --vpp-ngx-truehdr --colormatrix bt2020nc --colorprim bt2020 --transfer smpte2084 -i %%A -o %%A_HDR_.mkv 
