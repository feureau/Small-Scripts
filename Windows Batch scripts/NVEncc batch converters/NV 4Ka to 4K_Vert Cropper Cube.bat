...
start /b /belownormal /wait NVEncC64 --avhw --codec av1 --tier 1 --profile main --cqp 12 --preset p1 --output-depth 10 --transfer auto --audio-copy --chapter-copy --key-on-chapter --sub-copy --metadata copy --crop 618,0,618,0 --vpp-resize algo=ngx-vsr,vsr-quality=1 --output-res 2160x2700,preserve_aspect_ratio=increase -i %%A -o %%A_HDR_4K_Vert.mkv 
