...
NVEncC64 --avhw --codec av1 --profile high --qvbr 0 --preset p4 --output-depth 10 --multipass 2pass-full --lookahead 32 --nonrefp --aq --aq-temporal --transfer auto --audio-copy --chapter-copy --key-on-chapter --metadata copy --vpp-resize algo=nvvfx-superres,superres-mode=1,superres-strength=1.0 --output-res 4320x4320,preserve_aspect_ratio=increase -i %%A_temp_HDR_4K.mkv -o %%A_temp_HDR_8K.mkv 
