...
start /b /belownormal /wait ffmpeg -ss 00:00.00 -to 00:18.51 -accurate_seek -i %%A -c:v prores_ks -profile:v 3 -color_primaries bt709 -color_trc bt709 -colorspace bt709 -c:a copy -c:s copy -map 0 -map_metadata 0 %%A_cut.mkv
