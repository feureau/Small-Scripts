...
def flare_b_prop(obs, context, lensflareprop, suffix):
...
##### IRIS 02 #####
    ...
    #estressione matematica da fare con le variabili create
    d.expression = "(global_emission+0.2)"
...
##### IRIS 04 #####            
    ...
    v2.targets[0].data_path = "lensflareprop.streak_emission"    
    #estressione matematica da fare con le variabili create
    d.expression = "global_emission/2+streak_emission"
...
##### IRIS 05 #####
    ...
    #estressione matematica da fare con le variabili create
    d.expression = "global_emission+0.7"
...
##### IRIS 07 ##### 
    ...
    v2.targets[0].data_path = "lensflareprop.iris_emission"    
    #estressione matematica da fare con le variabili create
    d.expression = "global_emission+(iris_emission/2)"
